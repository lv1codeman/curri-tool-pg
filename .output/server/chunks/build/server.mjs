import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { reactive, watchEffect, toRef, getCurrentInstance as getCurrentInstance$1, warn, watch, onScopeDispose, camelize, isVNode, Comment, Fragment, inject as inject$1, shallowRef, computed, toValue, capitalize, ref, toRaw, defineComponent as defineComponent$1, provide, unref, effectScope, isRef, createVNode, mergeProps, createElementVNode, hasInjectionContext, normalizeClass, defineAsyncComponent, h, shallowReactive, Suspense, createApp, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, getCurrentScope, withCtx, nextTick, isReadonly, useSSRContext, isShallow, isReactive, toRefs } from 'vue';
import { p as parseURL, e as encodePath, m as decodePath, w as withQuery, n as hasProtocol, o as isScriptProtocol, l as joinURL, q as sanitizeStatusCode, r as getContext, $ as $fetch, v as defu, x as createHooks, i as createError$1, y as executeAsync, z as getRequestHeaders, A as setResponseHeader, B as klona, C as getRequestHeader, d as destr, D as isEqual$1, E as setCookie, F as getCookie, G as deleteCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "403",
    path: "/403",
    component: () => import('./403-DmEjlGrL.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$e || {},
    component: () => import('./index-DJuCG0ur.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-BEOaYrzo.mjs')
  },
  {
    name: "index2",
    path: "/index2",
    component: () => import('./index2-CQvlcryJ.mjs')
  },
  {
    name: "welcome",
    path: "/welcome",
    meta: __nuxt_page_meta$d || {},
    component: () => import('./welcome-DJCImXlh.mjs')
  },
  {
    name: "test-api",
    path: "/test-api",
    component: () => import('./test-api-B4iIuJwB.mjs')
  },
  {
    name: "Info-info",
    path: "/Info/info",
    meta: __nuxt_page_meta$c || {},
    component: () => import('./info-DELAyS_R.mjs')
  },
  {
    name: "DB-Members",
    path: "/DB/Members",
    meta: __nuxt_page_meta$b || {},
    component: () => import('./Members-FT8dxR0G.mjs')
  },
  {
    name: "Tools-Meme",
    path: "/Tools/Meme",
    meta: __nuxt_page_meta$a || {},
    component: () => import('./Meme-CvzOeCL0.mjs')
  },
  {
    name: "Sixer-Upload",
    path: "/Sixer/Upload",
    meta: __nuxt_page_meta$9 || {},
    component: () => import('./Upload-D-QhWqVA.mjs')
  },
  {
    name: "DB-CurriAgent",
    path: "/DB/CurriAgent",
    meta: __nuxt_page_meta$8 || {},
    component: () => import('./CurriAgent-DZ4oomjb.mjs')
  },
  {
    name: "DB-DBmaintain",
    path: "/DB/DBmaintain",
    meta: __nuxt_page_meta$7 || {},
    component: () => import('./DBmaintain-CC27KPB3.mjs')
  },
  {
    name: "Sixer-NTEdaily",
    path: "/Sixer/NTEdaily",
    component: () => import('./NTEdaily-BPXhs6el.mjs')
  },
  {
    name: "Sixer-Minecraft",
    path: "/Sixer/Minecraft",
    meta: __nuxt_page_meta$6 || {},
    component: () => import('./Minecraft-CjKzHPoR.mjs')
  },
  {
    name: "Converters-Bdate",
    path: "/Converters/Bdate",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./Bdate-SO-PFRhz.mjs')
  },
  {
    name: "DB-ClassDeptshort",
    path: "/DB/ClassDeptshort",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./ClassDeptshort-D-NTMnr9.mjs')
  },
  {
    name: "Tools-YTconverter",
    path: "/Tools/YTconverter",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./YTconverter-DWKkqKh6.mjs')
  },
  {
    name: "Converters-SIDtoSYS",
    path: "/Converters/SIDtoSYS",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./SIDtoSYS-C-uDpYJO.mjs')
  },
  {
    name: "Converters-ClassToOthers",
    path: "/Converters/ClassToOthers",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./ClassToOthers-Bo2B0lpF.mjs')
  },
  {
    name: "Converters-CopyDeptsDetails",
    path: "/Converters/CopyDeptsDetails",
    meta: __nuxt_page_meta || {},
    component: () => import('./CopyDeptsDetails-DaSRAehC.mjs')
  }
];
...
const axios_CbxLgoiNwh2Oim8pobkzny0jYhazq9TmzoN6JOpY_90 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  ...
  api.interceptors.request.use((config2) => {
    const { token } = useUser();
    if (token.value) {
      config2.headers.Authorization = `Bearer ${token.value}`;
    }
    return config2;
  });
...
function vuetifyConfiguration() {
  const options = { "theme": { "defaultTheme": "light" }, "ssr": true };
  return options;
}
...
const vuetify_nuxt_plugin_server_9oTjuJUolTgCRp3b2GI8HpSG5efgavDBj_liwzqFHbg = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  ...
  axios_CbxLgoiNwh2Oim8pobkzny0jYhazq9TmzoN6JOpY_90,
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-b4JzM9jj.mjs').then((m) => m.default || m)),
  layout1: defineAsyncComponent(() => import('./layout1-CAZg5qWD.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Cn3fDJgQ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BY_Js_1f.mjs'));
...
export { destructComputed as $, keyValues as A, getCurrentInstance as B, clamp as C, defineFunctionalComponent as D, consoleError as E, isPrimitive as F, getObjectValueByPath as G, isEmpty as H, IconValue as I, makeDisplayProps as J, EventProp as K, getPropertyFromItem as L, useRuntimeConfig as M, debounce as N, useToggleScope as O, focusableChildren as P, camelizeProps as Q, ensureValidVNode as R, checkPrintable as S, matchesSelector as T, acceleratedEasing as U, deceleratedEasing as V, isClickInsideElement as W, focusChild as X, getNextElement as Y, useGoTo as Z, _export_sfc as _, useUser as a, CircularBuffer as a0, templateRef as a1, refElement as a2, getCurrentInstanceName as a3, consoleWarn as a4, breakpoints as a5, useRouter as a6, encodeRoutePath as a7, resolveRouteObject as a8, nuxtLinkDefaults as a9, defineComponent as aa, deprecate as ab, defer as ac, PREFERS_REDUCED_MOTION as ad, findChildrenWithProvide as ae, onlyDefinedProps as af, includes as ag, isCssColor as ah, isParsableColor as ai, parseColor as aj, getForeground as ak, useIcon as al, flattenFragments as am, hasEvent as an, useLocale as b, useProxiedModel as c, callEvent as d, entry_default as default, useTheme as e, filterInputAttrs as f, genericComponent as g, humanReadableFileSize as h, pickWithRest as i, provideTheme as j, keys as k, useRtl as l, makeThemeProps as m, navigateTo as n, omit as o, propsFactory as p, convertToUnit as q, provideDefaults as r, standardEasing as s, isObject as t, useNuxtApp as u, pick as v, wrapInArray as w, useDisplay as x, isOn as y, createRange as z };
