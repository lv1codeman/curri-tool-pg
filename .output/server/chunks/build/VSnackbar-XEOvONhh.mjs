import { ref, shallowRef, inject, watchEffect, watch, computed, createVNode, mergeProps, createElementVNode, Fragment, Teleport, withDirectives, vShow, onScopeDispose, reactive, provide, toValue, toRaw, toRef, readonly, nextTick, Transition } from 'vue';
import { s as usePosition, q as useVariant, d as useRounded, t as genOverlays, a as VProgressLinear, p as VDefaultsProvider, b as useBackgroundColor, B as useRouter, k as makeVariantProps, f as makeRoundedProps, v as makePositionProps, g as makeLocationProps, C as parseAnchor, D as flipSide, E as flipAlign, F as flipCorner, G as Box, h as deepEqual, x as getTargetBox, H as getElementBox, I as getAxis, J as getOverflow } from './index-DVrSdyte.mjs';
import { g as genericComponent, c as useProxiedModel, j as provideTheme, O as useToggleScope, a2 as refElement, B as getCurrentInstance, l as useRtl, q as convertToUnit, o as omit, p as propsFactory, m as makeThemeProps, a1 as templateRef, s as standardEasing, T as matchesSelector, $ as destructComputed, a0 as CircularBuffer, E as consoleError, C as clamp } from './server.mjs';
import { f as forwardRefs, a as animate, n as nullifyTransforms } from './forwardRefs-CJyhXHYH.mjs';
import { u as useFocusTrap, m as makeFocusTrapProps, a as useDelay, b as makeDelayProps } from './focusTrap-hyPXUrgo.mjs';
import { u as useRender, a as useDimension, b as makeDimensionProps, c as makeComponentProps } from './dimensions-B7KURZuc.mjs';
...
import { V as VuetifyLayoutKey, u as useLayout } from './layout-BYmWGd6C.mjs';
...
export { VSnackbar as V, VOverlay as a, VMenuSymbol as b, makeVOverlayProps as m };
//# sourceMappingURL=VSnackbar-XEOvONhh.mjs.map
