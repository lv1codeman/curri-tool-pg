import { toRef, useId, watch, shallowRef, ref, computed, inject, createVNode, normalizeStyle, normalizeClass, withDirectives, createElementVNode, vShow, mergeProps, watchEffect } from 'vue';
import { V as VExpandTransition } from './index-Cr-Vuh5O.mjs';
import { u as useNested, c as createList, d as useNestedItem, e as useList, f as VNestedSymbol, m as makeNestedProps, g as useNestedGroupActivator, V as VListItem } from './VListItem-BmLTdZa_.mjs';
...
import { g as genericComponent, j as provideTheme, c as useProxiedModel, r as provideDefaults, X as focusChild, p as propsFactory, I as IconValue, m as makeThemeProps, K as EventProp, F as isPrimitive, L as getPropertyFromItem, o as omit, aa as defineComponent, q as convertToUnit, v as pick } from './server.mjs';
import { u as useSsrBoot } from './ssrBoot-ZQn7gOuX.mjs';
import { M as MaybeTransition } from './VCard-BqUhiF6T.mjs';
import { b as useBackgroundColor, w as useBorder, u as useDensity, r as useElevation, d as useRounded, k as makeVariantProps, f as makeRoundedProps, n as makeElevationProps, m as makeDensityProps, o as makeBorderProps, p as VDefaultsProvider, c as useTextColor, h as deepEqual } from './index-DVrSdyte.mjs';
...
export { VList as V, VListSubheader as a, VListGroup as b, makeItemsProps as m, useItems as u };
//# sourceMappingURL=VList-7bIncbX4.mjs.map
